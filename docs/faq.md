...
- [TROUBLESHOOT](#troubleshoot)
  ...
  - [*Backup files not showing when trying to load backups*](insted of trying to look for the files you have to just select the folder, infact selecting the specter backup folder which contains the wallet and device folders will select all JSON files together)
