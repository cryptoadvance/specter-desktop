...
*Do you need Specter to have a wallet on your node for it to even start? I was hoping to try this without using the core wallet at all.*
...
Yes, it's a standard multisig. So you can recreate it as soon as you have **master public keys of the devices** - either with Specter, or Electrum.

When using Specter and importing old wallet you would need to rescan blockchain in the wallet settings page.
...
*I still get this error when I try to run specter with:*
