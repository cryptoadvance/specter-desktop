## v0.8.1 October 29, 2020

- Bugfix: Fix hash verification #554 (benk10)
- Bugfix: Fix CI related fixes #551 #552 #553 (benk10)
...
- Bugfix: Fix amount validation #516 (benk10)
- Bugfix: Fix display address on Specter HWI and an error when creating wallets #511 (benk10)
...
- Feature: Use Electron for desktop app #555 #473 (benk10)
...
- Feature: BIP39 passphrases, custom derivations and more for hot wallets #514 (benk10)
...
- Refactoring: Remove RPC calls from the UI #557 (benk10)
...
- Refactoring: Update HWI to 1.2.0 #506 (benk10)
