...
- Feature: #1016 - "Verify on device" asks to plug in an air-gapped cold card  #1157 (Manolis)
...
- Feature: Move backup PDF slip132 option to advanced #1168 (benk10)
- Feature: Managing more than one Node-connection and switch between them #1146 (benk10)
- Feature: Managing multiple internal nodes #1165 (benk10)
...
- Bugfix: issue selecting remote USB option #1147 (benk10)
- Bugfix: Fix #1164 #1171 (benk10)
- Bugfix: Fix #1177 #1180 (benk10)
- Bugfix: Hide sensitive info mode #1170 (benk10)
- Bugfix: Fix broadcast via block explorer #1191 (benk10)
- Bugfix: Fix sensitive info notification and xpub hiding #1189 (benk10)
- Bugfix: getting keys in wrong network format when no node is used #1188 (benk10)
