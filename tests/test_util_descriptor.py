...
def test_convert_receive_descriptor_to_combined_descriptor():
    ...
    expected_combined_descriptor_single_sig = "wpkh([1ef4e492/84h/1h/0h]tpubDC5EUwdy9WWpzqMWKNhVmXdMgMbi4ywxkdysRdNr1MdM4SCfVLbNtsFvzY6WKSuzsaVAitj6FmP6TugPuNT6yKZDLsHrSwMd816TnqX7kuc/{0,1}/*)#xp8lv5nr"
    ...
    assert (
        convert_receive_descriptor_to_combined_descriptor(
            expected_combined_descriptor_single_sig
        )
        == expected_combined_descriptor_single_sig
    )
