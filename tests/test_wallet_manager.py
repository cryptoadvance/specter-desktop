...
def test_wallet_createpsbt(bitcoin_regtest, devices_filled_data_folder, device_manager):
    ...
    psbt = wallet.createpsbt([random_address], [number_of_coins_to_spend], True, subtract_from=0, 10, selected_coins=selected_coins)
    ...
    try:
        psbt = wallet.createpsbt([random_address], [number_of_coins_to_spend +1], True, subtract_from=0, 10, selected_coins=selected_coins)
