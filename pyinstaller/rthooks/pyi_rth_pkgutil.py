# This file is a monkeypatch for https://github.com/pyinstaller/pyinstaller/issues/6537
# See the build-script for osx where it's applied
# Should be removed when the above issue is solved
