    ...
    def migrate_old_node_format(self):
        ...
        if old_internal_rpc and os.path.isfile(self.bitcoind_path):
            internal_node = InternalNode(
                ...
                old_internal_rpc("datadir", get_default_datadir()),
                old_internal_rpc("user", ""),
                old_internal_rpc("password", ""),
                old_internal_rpc("port", 8332),
                old_internal_rpc("host", "localhost"),
                old_internal_rpc("protocol", "http"),
                os.path.join(
        ...
        if old_rpc:
            node = Node(
                "Bitcoin Core",
                "default",
                old_internal_rpc.get("autodetect", True),
                old_internal_rpc("datadir", get_default_datadir()),
                old_internal_rpc("user", ""),
                old_internal_rpc("password", ""),
                old_internal_rpc("port", None),
                old_internal_rpc("host", "localhost"),
                old_internal_rpc("protocol", "http"),
                True,
