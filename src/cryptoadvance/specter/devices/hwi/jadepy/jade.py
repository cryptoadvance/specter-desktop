...
class JadeAPI:
    ...
    def get_bip85_bip39_entropy(self, num_words, index, pubkey):
        ...
        dict
            ...
            ecdh shared secret
        """
        params = {"num_words": num_words, "index": index, "pubkey": pubkey}
    ...
    def get_registered_multisig(self, multisig_name, as_file=False):
        ...
        """
        params = {"multisig_name": multisig_name, "as_file": as_file}
    ...
    def register_descriptor(
        self, network, descriptor_name, descriptor_script, datavalues=None
    ):
        """
...
class JadeInterface:
    ...
    def create_serial(device=None, baud=None, timeout=None):
        ...
        if device and JadeTCPImpl.isSupportedDevice(device):
            ...
            impl = JadeSerialImpl(
                device, baud or DEFAULT_BAUD_RATE, timeout or DEFAULT_SERIAL_TIMEOUT
            )
