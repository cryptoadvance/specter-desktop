...
class TrezorClient(HardwareWalletClient):
    ...
    def display_address(self, keypath, p2sh_p2wpkh, bech32, redeem_script=None, descriptor=None):
        ...
        if descriptor:
            ...
            multisig = proto.MultisigRedeemScriptType(m=int(descriptor.multisig_M), signatures=[b''] * int(descriptor.multisig_N), pubkeys=pubkeys)        # redeem_script means p2sh/multisig
        elif redeem_script:
