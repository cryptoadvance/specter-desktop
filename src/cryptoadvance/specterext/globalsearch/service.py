...
class GlobalsearchService(Service):
    id = "globalsearch"
    name = "Globalsearch Service"
    icon = "globalsearch/img/ghost.png"
    logo = "globalsearch/img/logo.jpeg"
    desc = "Where a globalsearch grows bigger."
    has_blueprint = True
    blueprint_module = "cryptoadvance.specterext.globalsearch.controller"
    ...
    def callback_after_serverpy_init_app(self, scheduler: APScheduler):
        ...
        # Global Search
        self.global_search_tree = GlobalSearchTree()
